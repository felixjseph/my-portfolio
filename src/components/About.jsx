  ...
  return (
    ...
    >
      <div className="text-center">
        <h1 className="relative bottom-10 text-6xl bg-linear-to-r from-red-400 to-yellow-400 bg-clip-text text-transparent font-extrabold mb-3">
          About Me
        </h1>

        <div className="relative bottom-9 w-24 h-1 bg-orange-400 mx-auto mt-4 mb-10 rounded-full"></div>
      </div>
